            ...
            <div className="drawer-content flex flex-col">
                ...
                <div className="navbar bg-base-100 border-b border-base-300 px-4 shadow-sm">
                    ...
                    <div className="flex-1">
                        <h1 className="text-2xl font-bold text-primaryGreen">Dashboard</h1>
                    </div>
            ...
            <div className="drawer-side z-50">
                ...
                <aside className="w-72 min-h-full bg-base-100 border-r border-base-300">
                    <div className="p-6 border-b border-base-300">
                        <h2 className="text-2xl font-bold text-primaryGreen">My Admin</h2>
                    ...
                    <ul className="menu p-4 text-base-content w-full gap-1">
                        ...
                        <li>
                            <Link href="/admin/users" className="rounded-xl">User</Link>
                        </li>
                        <li>
                            <Link href="/admin/products" className="rounded-xl">Produk</Link>
                        </li>
                        <li>
                            <Link href="/admin/orders" className="rounded-xl">Pesanan</Link>
                        </li>
                        <li>
                            <details>
                                <summary className="rounded-xl">Laporan</summary>
                                <ul>
                                    <li><Link href="/admin/reports/sales">Penjualan</Link></li>
                                    <li><Link href="/admin/reports/finance">Keuangan</Link></li>
                                </ul>
                            </details>
                        </li>
                        <li>
                            <Link href="/admin/settings" className="rounded-xl">Pengaturan</Link>
                        </li>
                    </ul>
                </aside>
            </div>
