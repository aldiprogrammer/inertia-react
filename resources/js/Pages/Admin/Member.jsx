...
export default function Member({member, kode}) {
    ...
    const editopenModal = (id, tgl_daftar, kode, nama, tgl_lahir, nohp, alamat) => {
                                      ...
                                      <form onSubmit={save}>
                                           <label className="form-control w-full mt-2">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    onChange={(e) => setData('tgl_daftar', e.target.value)}
                                                />
                                          ...
                                          <label className="form-control w-full mt-2">
                                           ...
                                           <label className="form-control w-full mt-2">
                                              ...
                                              <textarea name="alamat" className='input input-bordered input-success' id="
                                                "onChange={(e) => setData('alamat', e.target.value)} value={data.alamat}></textarea>
                                            </label>
                                ...
                                <tbody>
                                    {member.map((item, index) => (
                                        <tr>
                                            ...
                                            <td>{item.alamat}</td>
                                            <td>
                                               {item.status == 1 ? <div class="badge badge-primary">Aktif</div> : <div class="badge badge-error text-white">Tidak aktif</div>}
                                            </td>
                                            ...
                                            <td>
                                                <div className='flex gap-2'>
                                                    ...
                                                    <button className='btn btn-success btn-sm' onClick={() => editopenModal(item.id, item.tgl_daftar, item.kode, item.nama, item.tgl_lahir, item.nohp, item.alamat)}>Edit</button>
